<?php /* Template_ 2.2.7 2018/01/03 16:28:41 /www/designpix4_godomall_com/data/mail/body_INCASH.php 000007288 */ ?>
<div style="margin: auto; width: 600px; color: rgb(85, 85, 85); padding-right: 20px; padding-left: 20px; font-family: Malgun Gothic; font-size: 13px; background-color: rgb(255, 255, 255);">
    ...
    <div style="margin-bottom: 50px;">
        ...
        <div style="color: rgb(68, 68, 68); line-height: 22px; font-size: 13px; margin-top: 30px;">
            ...
            님, 저희 쇼핑몰을 이용하여 주셔서 감사합니다. <br> <?php echo $TPL_VAR["rc_orderNm"]?> 님께서 주문하신 상품에 대한 입금이 아래와 같이 확인되었습니다. <br> 고객님께 빠르고 정확하게 제품이 전달될 수 있도록 최선을 다하겠습니다.
        </div>
    </div>
    ...
    <table class="__se_tbl_ext" style="width: inherit; border-top-color: rgb(181, 181, 181); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="width: 80%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_paymentCheckDt"]?></td>
        </tr>
<?php if(empty($TPL_VAR["rc_bankSender"])==false){?>
        <tr>
            ...
            <td style="width: 80%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_bankSender"]?></td>
        </tr>
<?php }?>
        <tr>
...
<?php if(empty($TPL_VAR["rc_bank"])==false){?>
        <tr>
            ...
            <td style="width: 80%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_bank"]?></td>
        </tr>
<?php }?>
<?php if(empty($TPL_VAR["rc_accountHolder"])==false){?>
        <tr>
            <td style="height: 43px; text-align: left; color: rgb(136, 136, 136); padding-right: 20px; padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid; background-color: rgb(247, 247, 247);">
                <p>예금주</p>
            </td>
            <td style="width: 80%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_accountHolder"]?></td>
        </tr>
<?php }?>
<?php if(empty($TPL_VAR["rc_accountNumber"])==false){?>
        <tr>
            ...
            <td style="width: 80%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_accountNumber"]?></td>
        </tr>
<?php }?>
        </tbody>
    </table>
