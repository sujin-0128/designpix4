<?php /* Template_ 2.2.7 2017/03/30 08:56:41 /www/designpix4_godomall_com/data/mail/body_HACKOUT.php 000002813 */ ?>
<div style="margin: auto; width: 600px; color: rgb(85, 85, 85); padding-right: 20px; padding-left: 20px; font-family: Malgun Gothic; font-size: 13px; background-color: rgb(255, 255, 255);">
    ...
    <div style="margin-bottom: 50px;">
        <div style="color: rgb(68, 68, 68); letter-spacing: -2px; font-size: 32px;">
            <b>회원탈퇴가</b><br>완료되었습니다 <img style="margin-top: -40px; margin-right: 10px; float: right;" alt="hack out top image" src="/data/mail/img/mailimg_drawal.png">
        </div>
        <div style="line-height: 22px; margin-top: 30px;"> 안녕하세요.
            <strong><?php echo $TPL_VAR["rc_mallNm"]?></strong>
            입니다. <br> 그동안 <?php echo $TPL_VAR["rc_mallNm"]?>을 이용해주신 <?php echo $TPL_VAR["rc_memNm"]?>님께 감사드립니다. <br> 요청하신 회원탈퇴가 완료되었음을 알려드립니다. <br> <br> <?php echo $TPL_VAR["rc_memNm"]?>님께 만족스런 쇼핑경험을 드리지 못한 점 송구스럽게 생각하며, <br> 다음 기회에 더 발전한 <?php echo $TPL_VAR["rc_mallNm"]?>의 모습을 보여드릴 수 있도록 노력하겠습니다.
            <br> 기타 문의사항이 있으시면 고객센터메일 으로 연락주시기 바랍니다. <br> <br> 감사합니다.
        </div>
    </div>
