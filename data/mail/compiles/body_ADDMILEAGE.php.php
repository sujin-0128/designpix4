<?php /* Template_ 2.2.7 2017/03/30 08:56:41 /www/designpix4_godomall_com/data/mail/body_ADDMILEAGE.php 000005370 */ ?>
<div style="margin: auto; width: 600px; color: rgb(85, 85, 85); padding-right: 20px; padding-left: 20px; font-family: Malgun Gothic; font-size: 13px; background-color: rgb(255, 255, 255);">
    ...
    <div style="margin-bottom: 50px;">
        ...
        <div style="line-height: 22px; margin-top: 30px;">
            안녕하세요. <b><?php echo $TPL_VAR["rc_mallNm"]?></b>입니다. <?php echo $TPL_VAR["rc_memNm"]?>님께 감사의 의미로 마일리지를 지급해드렸습니다. 적립하신 마일리지는 <?php echo $TPL_VAR["rc_mallNm"]?>에서 상품 결제 시 사용하실 수 있습니다. 소멸된 마일리지는 복구되지 않으니 유효기간 내에 사용하시기 바랍니다.
        </div>
    </div>
    ...
    <table class="__se_tbl_ext" style="width: inherit; border-top-color: rgb(186, 186, 186); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="width: 70%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_deleteScheduleDt"]?></td>
        </tr>
        </tbody>
    </table>
