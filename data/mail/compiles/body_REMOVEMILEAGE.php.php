<?php /* Template_ 2.2.7 2017/03/30 08:56:41 /www/designpix4_godomall_com/data/mail/body_REMOVEMILEAGE.php 000004617 */ ?>
<div style="margin: auto; width: 600px; color: rgb(85, 85, 85); padding-right: 20px; padding-left: 20px; font-family: Malgun Gothic; font-size: 13px; background-color: rgb(255, 255, 255);">
    ...
    <div style="margin-bottom: 50px;">
        <div style="color: rgb(68, 68, 68); letter-spacing: -2px; font-size: 32px;">
            <b>마일리지가</b><br><b>차감</b>되었습니다. <img style="margin-top: -40px; margin-right: 10px; float: right;" alt="mileage-minus top image" src="/data/mail/img/mailimg_mileage-minus.png">
        </div>
        <div style="line-height: 22px; margin-top: 30px;"> 안녕하세요.
            <strong><?php echo $TPL_VAR["rc_mallNm"]?></strong>
            입니다. <br> <?php echo $TPL_VAR["rc_memNm"]?>님의 마일리지 중 일부가 차감되어 안내드립니다.
        </div>
    </div>
    ...
    <table class="__se_tbl_ext" style="width: inherit; border-top-color: rgb(186, 186, 186); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;">
        ...
        <tr>
            <td style="height: 43px; color: rgb(136, 136, 136); padding-right: 20px; padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid; background-color: rgb(243, 243, 243);">차감 마일리지</td>
            <td style="width: 70%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_mileage"]?></td>
        </tr>
        <tr>
            <td style="height: 43px; color: rgb(136, 136, 136); padding-right: 20px; padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid; background-color: rgb(243, 243, 243);">차감 후 보유마일리지</td>
            <td style="width: 70%; height: 43px; color: rgb(51, 51, 51); padding-left: 20px; font-size: 13px; border-bottom-color: rgb(229, 229, 229); border-bottom-width: 1px; border-bottom-style: solid;"><?php echo $TPL_VAR["rc_totalMileage"]?></td>
        </tr>
        </tbody>
    </table>
