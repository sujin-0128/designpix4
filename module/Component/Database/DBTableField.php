...
class DBTableField extends \Bundle\Component\Database\DBTableField
{
    ...
    /**
     * [LOG] tableBundleDiscountGoods 기본값
     *
     * @author sjlee
     * @return array tableBundleDiscountGoods 테이블 필드 정보
     */
    public static function tableBundleDiscountGoods()
    {
        // @formatter:off
        $arrField = [
